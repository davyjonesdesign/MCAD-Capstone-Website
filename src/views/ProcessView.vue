      ...
      content: [
        ...
        { 
          ...
          text: [
            ...
            { text: 'Pastor Kevin Earhart stressed accurate info, easy navigation, and historical period filtering.' },
            { text: 'Emma Austin, Old Testament Lecturer and PhD candidate', style: 'subhead' },
            { text: 'Ms. Emma Austin highlighted some key challenges and suggested to relegate all non-geographical info to an academic overview section/download. She also stressed the importance of cross-references between sites and creating a way for users to ‘find their path’ to walk through the app.' },
